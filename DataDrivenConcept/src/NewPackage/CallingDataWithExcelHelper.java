...
public class CallingDataWithExcelHelper {
 
//this is the driver
public	WebDriver driver;
public String URL = "http://newtours.demoaut.com";
     public  String path ="/Users/rjm/eclipse-workspace/DataDrivenConcept/src/Registration.xlsx";       
public String sheetName="Sheet1"; 

@BeforeTest
   public void openApplication() throws InterruptedException
   {
	System.setProperty("webdriver.chrome.driver", "/Users/rjm/Desktop/chromedriver");
...
datamap =  ExcelHelper.getData(path,sheetName);
    ...
    for (int row = 0; row <= 2; row++) {
   	...
   	System.out.println( "demo Test 2: verify user registration test, Row number is :"+ row );
